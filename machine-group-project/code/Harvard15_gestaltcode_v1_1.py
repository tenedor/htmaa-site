...
class virtualMachine(machines.virtualMachine):
    ...
    def initControllers(self):
        ...
        self.xabyzexNode = nodes.compoundNode(
            self.xaAxisNode, self.xbAxisNode, self.yAxisNode, self.zAxisNode, self.extruderNode)

    def initCoordinates(self):
        self.position = state.coordinate(['mm', 'mm', 'mm', 'mm', 'mm'])
    ...
    def initFunctions(self):
        self.move = functions.move(virtualMachine=self, virtualNode=self.xabyzexNode, 
                                   axes=[self.xaAxis, self.xbAxis, self.yAxis, self.zAxis, self.extruder], 
...
if __name__ == '__main__':
    ...
    for lines in text_file:
        ...
        if len(chars) == 3:
            move = [chars[0], chars[0], chars[1], 0, chars[2]]
        else:
            move = [chars[0], chars[0], chars[1], chars[2], chars[3]]
